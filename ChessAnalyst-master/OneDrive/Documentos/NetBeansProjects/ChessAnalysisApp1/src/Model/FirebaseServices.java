...
public class FirebaseServices {
    ...
    private static void initFirebase() {
        ...
        try {
            ...
            File file = new File("src/resources/firebase-token.json"); // Ruta relativa, ajustar si es necesario
            if (!file.exists()) {
            ...
            FirebaseOptions firebaseOptions = new FirebaseOptions.Builder()
                    .setCredentials(GoogleCredentials.fromStream(new FileInputStream("src/resources/firebase-token.json"))) // Ruta relativa, ajustar si es necesario
                    .setDatabaseUrl("https://TU_DATABASE.firebaseio.com/") // Cambia esta URL por la de tu base de datos
                    .build();
